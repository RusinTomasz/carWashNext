...
interface IttegularitiesFormContainerProps {
    carWashName: string
}

const IttegularitiesFormContainer = (props: IttegularitiesFormContainerProps) => {
    const {carWashName} = props;
    ...
    const sendEmail = async () => {
        const isEmailSend = await sendBasicEmail({
            ...
            name: state.name,
            subject: state.subject + carWashName,
            email: state.email,
